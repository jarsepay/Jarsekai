...
fs.writeFileSync(tmpFileIn, wMedia)
 ...
 if (metadata.packname || metadata.author) {
  ...
  const json = { "sticker-pack-id": `Bronya - MD`, "sticker-pack-name": metadata.packname, "sticker-pack-publisher": metadata.author, "emojis": metadata.categories ? metadata.categories : [""] }
